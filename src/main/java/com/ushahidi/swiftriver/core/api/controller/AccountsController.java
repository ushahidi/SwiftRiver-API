...
public class AccountsController {
	...
	@ResponseBody
	public Account modifyAccount(@RequestBody Map<String, Object> body, @PathVariable Long id) {
		throw new UnsupportedOperationException("Method Not Yet Implemented ");
	}
	
	@RequestMapping(value = "/{id}/verify", method = RequestMethod.POST)
	@ResponseBody
	public Account verifyAccount(@RequestBody Map<String, Object> body, @PathVariable Long id) {
		throw new UnsupportedOperationException("Method Not Yet Implemented");
	}
	
	@RequestMapping(value = "/{id}/followers", method = RequestMethod.POST)
	@ResponseBody
	public Account addFollower(@RequestBody Map<String, Object> body, @PathVariable Long id) {
		throw new UnsupportedOperationException("Method Not Yet Implemented");
	}
	...
	@ResponseBody
	public Account createApp(@RequestBody Map<String, Object> body, @PathVariable Long id) {
		throw new UnsupportedOperationException("Method Not Yet Implemented");
	}
	...
	@ResponseBody
	public Account modifyApp(@RequestBody Map<String, Object> body, @PathVariable Long id, @PathVariable Long appId) {
		throw new UnsupportedOperationException("Method Not Yet Implemented");
	}
